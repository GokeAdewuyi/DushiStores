        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                ...
                */
                ...
                'X-USER-KEY' => [ // Unique name of security
                    'type' => 'http', // The type of the security scheme. Valid values are "basic", "apiKey" or "oauth2".
                    'description' => 'Enter USER unique KEY',
                    'name' => 'X-USER-KEY', // The name of the header or query parameter to be used.
                    'in' => 'header', // The location of the API key. Valid values are "query" or "header".
                    'scheme' => 'bearer',
                ],
